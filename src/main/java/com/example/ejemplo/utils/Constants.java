...
public class Constants {
    ...
    public static final String MODIFYACCOMMODATION_FXML = "/com/example/ejemplo/fxml/ModifyAccommodation.fxml";
    ...
    public static final String DETAILSACCOMMODATION_FXML = "/com/example/ejemplo/fxml/AccommodationDetails.fxml";
